...
const MTN = [
  { k:'zula',     l:'Žula',      c:'#9A8E86', price:60,  ic:'granite', tier:4 },
  { k:'bridlice', l:'Břidlice',  c:'#5E6470', price:70,  ic:'slate2',  tier:4 },
  { k:'kremen',   l:'Křemen',    c:'#C6CEDA', price:90,  ic:'quartz',  tier:4 },
  { k:'kvadr',    l:'Kvádry',    c:'#B0A498', price:230, ic:'block',   tier:4 },
  { k:'tabule',   l:'Tabule',    c:'#6E7684', price:270, ic:'shingle', tier:4 },
  { k:'sklo',     l:'Sklo',      c:'#A8D0DC', price:340, ic:'pane',    tier:4 }
];
...
const BUILDINGS = {
  ...
  dispecink: {
    ...
    reqLvl:80, span:3, big:true, draw:[180,260,360], wdraw:[60,90,130], needPower:true,
  ...
  sprava: {
    ...
    reqLvl:81, span:3, big:true, draw:[150,220,300], wdraw:[50,80,110], needPower:true,
  ...
  udrzba: {
    ...
    reqLvl:82, span:2, big:true, draw:[90,130,180], wdraw:[30,50,70], needPower:true,
    autoFix:[2.0, 1.6, 1.3],
    up:[
  ...
  hsklad: {
    ...
    up:[
      { reqLvl:84, cost:2400000,  need:{kvadr:120,traverza:160}, dur:110000, xp:180000, label:'Přístavba haly' },
      { reqLvl:90, cost:11000000, need:{kvadr:280,tabule:200},   dur:140000, xp:520000, label:'Druhá hala' },
      { reqLvl:96, cost:44000000, need:{sklo:240,kvadr:420},     dur:170000, xp:1400000,label:'Podzemní zásobník' }],
    vars:[
    ...
    ph:[
      { n:'Vyrovnání terénu', need:{sterk:280}, xp:30000 },
      { n:'Základy do skály', need:{roxor:200}, xp:34000 },
      { n:'Hala',             need:{traverza:120,dlazba:240}, xp:38000 },
      { n:'Zastřešení',       need:{obklad:220,izolace:200}, xp:44000 }]
  },
  hvoda: {
    name:'Horská elektrárna', dur:110000, money:0, rent:0, reqLvl:81, span:3, big:true,
    mgen:[40, 110, 260, 520], flood:[0, 92, 104, 116],
    up:[
      { reqLvl:85, cost:3400000,  need:{kvadr:140,roxor:240},   dur:130000, xp:220000,  label:'Druhá turbína' },
      { reqLvl:91, cost:14000000, need:{tabule:200,traverza:220},dur:160000, xp:600000,  label:'Vyšší jez' },
      { reqLvl:97, cost:56000000, need:{sklo:280,kvadr:400},    dur:190000, xp:1600000, label:'Přehradní hráz' }],
    vars:[
  ...
  lanovka: {
    name:'Lanovka', dur:100000, money:0, rent:0, reqLvl:82, span:2, big:true,
    mdraw:[30, 50, 80], cable:true,
    up:[
      { reqLvl:88, cost:4400000, need:{kvadr:120,tabule:100}, dur:120000, xp:280000, label:'Druhé lano' },
      { reqLvl:94, cost:17000000,need:{sklo:140,traverza:200},dur:150000, xp:760000, label:'Kabinková lanovka' }],
    vars:[
    ...
    ph:[
      ...
      { n:'Stanice a vozíky',need:{kvadr:80,dlazba:180}, xp:40000 }]
  },
  chata: {
    sea:[1.0, 1.7],
    name:'Horská chata', dur:90000, money:200000, rent:2200, rentCap:22000,
    reqLvl:83, span:2, big:true, mdraw:[40, 70, 110],
    up:[
      { reqLvl:88, cost:3000000, need:{kvadr:100,tabule:90},  dur:110000, rentMul:1.9, xp:240000, label:'Podkroví a terasa' },
      { reqLvl:95, cost:13000000,need:{sklo:120,kvadr:220},   dur:140000, rentMul:3.0, xp:680000, label:'Wellness a krb' }],
    vars:[
    ...
    ph:[
      ...
      { n:'Okna a krb',       need:{sklo:60,obklad:150}, xp:42000 }]
  },
  kamdilna: {
    name:'Kamenická dílna', dur:110000, money:0, rent:0, reqLvl:84, span:3, big:true,
    mdraw:[70,110,160], makes:['kvadr'], mqueue:[20,40,70], mdur:[14000,9000,6000],
    up:[{ reqLvl:89, cost:6000000,  need:{kvadr:140,traverza:180}, dur:130000, xp:300000, label:'Druhá linka' },
        { reqLvl:95, cost:22000000, need:{sklo:160,kvadr:300},     dur:160000, xp:800000, label:'Automatická pila' }],
    vars:[{ n:'Kamenná', style:{ wall:'#9A9490', roof:'#4E545C', roofT:'gable', chim:true }, mix:{} },
          { n:'Dřevěná', style:{ wall:'#8A6E4A', roof:'#5E6470', roofT:'gable', chim:true }, mix:{traverza:'tram'} },
  ...
  krytina: {
    name:'Krytinárna', dur:110000, money:0, rent:0, reqLvl:86, span:3, big:true,
    mdraw:[80,120,175], makes:['tabule'], mqueue:[20,40,70], mdur:[14000,9000,6000],
    up:[{ reqLvl:91, cost:8000000,  need:{tabule:140,traverza:200}, dur:130000, xp:340000, label:'Druhá štípačka' },
        { reqLvl:96, cost:26000000, need:{sklo:180,tabule:320},     dur:160000, xp:880000, label:'Automatická linka' }],
    vars:[{ n:'Břidlicová',style:{ wall:'#6E7684', roof:'#4E545C', roofT:'gable', chim:true }, mix:{} },
          { n:'Kamenná',   style:{ wall:'#9A9490', roof:'#5A6470', roofT:'gable', chim:true }, mix:{traverza:'kvadr'} },
          { n:'Dřevěná',   style:{ wall:'#8A6E4A', roof:'#5E6470', roofT:'gable', chim:true }, mix:{tabule:'tram'} }],
  ...
  sklarna: {
    name:'Sklárna', dur:130000, money:0, rent:0, reqLvl:91, span:3, big:true,
    mdraw:[130,190,270], makes:['sklo'], mqueue:[20,40,70], mdur:[16000,10000,6500],
    up:[{ reqLvl:95, cost:16000000, need:{kvadr:220,traverza:260}, dur:150000, xp:520000,  label:'Druhá pec' },
        { reqLvl:99, cost:50000000, need:{sklo:300,tabule:360},    dur:180000, xp:1300000, label:'Vanová pec' }],
    vars:[{ n:'Cihlová',  style:{ wall:C.brick,   roof:'#4E545C', roofT:'gable', chim:true }, mix:{} },
          { n:'Kamenná',  style:{ wall:'#9A9490', roof:'#5A6470', roofT:'gable', chim:true }, mix:{traverza:'kvadr'} },
          { n:'Moderní',  style:{ wall:'#A8D0DC', roof:'#4E5450', roofT:'hip',   chim:true }, mix:{kvadr:'sklo'} }],
  ...
  pila: {
    ...
    up:[{ reqLvl:88, cost:4000000,  need:{kvadr:100,roxor:200}, dur:120000, xp:260000, label:'Druhý katr' },
        { reqLvl:94, cost:14000000, need:{tabule:160,kvadr:240},dur:150000, xp:700000, label:'Pásová pila' }],
  ...
  hvitr: {
    ...
    mgen:[120, 260, 480],
    up:[{ reqLvl:94, cost:12000000, need:{kvadr:180,traverza:200}, dur:140000, xp:420000,  label:'Delší listy' },
        { reqLvl:99, cost:40000000, need:{sklo:200,kvadr:340},     dur:170000, xp:1100000, label:'Vyšší stožár' }],
  ...
  hhotel: {
    sea:[1.2, 1.6],
    name:'Horský hotel', dur:140000, money:400000, rent:5200, rentCap:52000,
    reqLvl:90, span:3, big:true, mdraw:[140,200,290],
    up:[{ reqLvl:95, cost:24000000, need:{kvadr:240,sklo:140}, dur:160000, rentMul:1.9, xp:640000,  label:'Wellness' },
        { reqLvl:100,cost:80000000, need:{sklo:300,tabule:340},dur:190000, rentMul:3.0, xp:1700000, label:'Nová budova' }],
  ...
  lazne: {
    sea:[1.7, 1.0],
    name:'Horské lázně', dur:130000, money:250000, rent:3400, rentCap:34000,
    reqLvl:88, span:3, big:true, mdraw:[110,160,230],
    up:[{ reqLvl:93, cost:16000000, need:{kvadr:200,sklo:110}, dur:150000, rentMul:1.9, xp:520000,  label:'Venkovní bazén' },
        { reqLvl:98, cost:56000000, need:{sklo:260,tabule:280},dur:180000, rentMul:2.9, xp:1400000, label:'Termální vrt' }],
  ...
  sjezdovka: {
    sea:[0.3, 2.3],
    name:'Sjezdovka s vlekem', dur:150000, money:300000, rent:3800, rentCap:38000,
    reqLvl:84, span:4, big:true, mdraw:[120,180,260], tour:[0.10, 0.17, 0.26],
    up:[{ reqLvl:90, cost:18000000, need:{kvadr:180,traverza:220}, dur:170000, rentMul:1.8, xp:560000,  label:'Druhý vlek' },
        { reqLvl:96, cost:60000000, need:{sklo:200,tabule:320},    dur:200000, rentMul:2.8, xp:1500000, label:'Umělé zasněžování' }],
  ...
  rozhledna: {
    name:'Rozhledna', dur:170000, money:600000, rent:0, reqLvl:94, span:3, big:true,
    mdraw:[60,90,130], tour:[0.18, 0.30, 0.46],
    up:[{ reqLvl:98, cost:60000000,  need:{kvadr:340,sklo:200},  dur:200000, xp:1600000, label:'Vyšší ochoz' },
        { reqLvl:104,cost:200000000, need:{sklo:420,tabule:500}, dur:240000, xp:4000000, label:'Prosklená kupole' }],
  ...
  zubacka: {
    sea:[1.8, 0.8],
    name:'Zubačka', dur:180000, money:500000, rent:2600, rentCap:26000,
    reqLvl:92, span:4, big:true, mdraw:[180,260,360], tour:[0.12, 0.20, 0.30],
    up:[{ reqLvl:97, cost:44000000,  need:{kvadr:300,traverza:340}, dur:200000, rentMul:1.8, xp:1200000, label:'Druhá souprava' },
        { reqLvl:103,cost:150000000, need:{sklo:360,tabule:420},    dur:240000, rentMul:2.7, xp:3200000, label:'Horní stanice' }],
  ...
  meteo: {
    ...
    up:[{ reqLvl:94, cost:9000000,  need:{kvadr:120,sklo:80},  dur:130000, xp:340000, label:'Radar' },
        { reqLvl:100,cost:30000000, need:{sklo:180,tabule:200},dur:160000, xp:900000, label:'Předpovědní model' }],
  ...
  hsluzba: {
    ...
    up:[{ reqLvl:93, cost:8000000,  need:{kvadr:110,roxor:220}, dur:130000, xp:320000, label:'Druhé vozidlo' },
        { reqLvl:99, cost:28000000, need:{tabule:180,kvadr:260},dur:160000, xp:860000, label:'Vrtulník' }],
...
const PLANT = {
  ...
  blocks:[
    ...
    { mw:5400, burn:11000, water:400, cool:7, cost:9000000, need:{traverza:260,obklad:400},dur:180000, xp:700000, reqLvl:73 }],
  burnBase:18000
};
...
const PUMPST = { water:220, mw:36, dur:60000, xp:6000 };
...
const ST_UP = {
  ...
  granite:[
    { name:'Žulový lom', lvl:1, cost:700000, reqLvl:80, dur:120000, cap:80, mul:.7, queue:20, mw:40, done:120000,
      makes:[],
    ...
    { name:'Velký žulový lom', lvl:2, cost:6000000, reqLvl:86, dur:160000, cap:180, mul:.5, queue:40, mw:90, done:400000,
      makes:[],
    ...
    { name:'Kamenický kombinát', lvl:3, cost:30000000, reqLvl:93, dur:200000, cap:340, mul:.36, queue:70, mw:170, done:1400000,
      makes:[],
  ...
  slateq:[
    { name:'Břidlicová stěna', lvl:1, cost:1600000, reqLvl:82, dur:130000, cap:80, mul:.75, queue:20, mw:50, done:180000,
      makes:[],
    ...
    { name:'Velký břidlicový lom', lvl:2, cost:9000000, reqLvl:89, dur:170000, cap:180, mul:.52, queue:40, mw:110, done:520000,
      makes:[],
    ...
    { name:'Břidlicový kombinát', lvl:3, cost:42000000, reqLvl:95, dur:210000, cap:340, mul:.38, queue:70, mw:190, done:1700000,
      makes:[],
  ...
  quartz:[
    { name:'Křemenná štola', lvl:1, cost:4000000, reqLvl:85, dur:150000, cap:70, mul:.85, queue:20, mw:70, done:340000,
      makes:[],
    ...
    { name:'Hlubinná štola', lvl:2, cost:18000000, reqLvl:92, dur:190000, cap:160, mul:.58, queue:40, mw:150, done:900000,
      makes:[],
    ...
    { name:'Sklářský kombinát', lvl:3, cost:70000000, reqLvl:98, dur:220000, cap:300, mul:.42, queue:70, mw:240, done:2600000,
      makes:[],
...
const PLATFORMS = [
  ...
  { id:21,name:'Žulový lom',        ox:13, oy:52, mtn:true, reqLvl:80 },
  { id:22,name:'Podhůří',           ox:26, oy:52, mtn:true, reqLvl:82 },
  { id:23,name:'Údolí potoka',      ox:39, oy:52, mtn:true, reqLvl:81 },
  { id:24,name:'Břidlicová stěna',  ox:52, oy:52, mtn:true, reqLvl:84 },
  { id:25,name:'Východní úbočí',    ox:65, oy:52, mtn:true, reqLvl:86 },
  { id:26,name:'Západní svah',      ox:0, oy:65, mtn:true, reqLvl:83 },
  { id:27,name:'Kamenické dílny',   ox:13, oy:65, mtn:true, reqLvl:85 },
  { id:28,name:'Sedlo',             ox:26, oy:65, mtn:true, reqLvl:87 },
  { id:29,name:'Přehradní profil',  ox:39, oy:65, mtn:true, reqLvl:88 },
  { id:30,name:'Křemenná štola',    ox:52, oy:65, mtn:true, reqLvl:90 },
  { id:31,name:'Východní sedlo',    ox:65, oy:65, mtn:true, reqLvl:92 },
  { id:32,name:'Horská osada',      ox:0, oy:78, mtn:true, reqLvl:86 },
  { id:33,name:'Pod vrcholem',      ox:13, oy:78, mtn:true, reqLvl:89 },
  { id:34,name:'Vrchol Kamenné',    ox:26, oy:78, mtn:true, reqLvl:94 },
  { id:35,name:'Zatopené údolí',    ox:39, oy:78, mtn:true, reqLvl:91 },
  { id:36,name:'Vrchol Sklenné',    ox:52, oy:78, mtn:true, reqLvl:96 },
  { id:37,name:'Hřeben',            ox:65, oy:78, mtn:true, reqLvl:98 }
];
...
const PARC = {
  ...
  w6:{ name:'Úpravna vody',      gx:31, gy:9, span:3, plat:5, cost:400000, pumpst:true, reqLvl:60,
       water:520, mw:80, dur:100000, xp:40000, need:{roxor:70,obklad:90} },
  ...
  /* ═══ HORSKÝ KRAJ ═══ */
  /* 20 Koncová stanice */
  q1:{ name:'Nádražní sklad',  gx:1,  gy:53, span:3, plat:20, cost:0,       mtrain:true, free:true },
  q2:{ name:'Horský sklad',    gx:6,  gy:53, span:3, plat:20, cost:400000,  accept:['hsklad'],  reqLvl:80 },
  q3:{ name:'Chata u nádraží', gx:1,  gy:58, span:2, plat:20, cost:900000,  accept:['chata'],   reqLvl:83 },
  q4:{ name:'Lanovka k lomu',  gx:6,  gy:58, span:2, plat:20, cost:700000,  accept:['lanovka'], reqLvl:82 },
  /* 21 Žulový lom */
  q5:{ name:'Kamenická dílna', gx:14, gy:53, span:3, plat:21, cost:1400000, accept:['kamdilna'],reqLvl:84 },
  q6:{ name:'Chata nad lomem', gx:20, gy:53, span:2, plat:21, cost:1600000, accept:['chata'],   reqLvl:85 },
  q7:{ name:'Sklad u lomu',    gx:14, gy:60, span:3, plat:21, cost:3000000, accept:['hsklad'],  reqLvl:87 },
  /* 22 Podhůří */
  q8:{ name:'Podhorská chata', gx:27, gy:53, span:2, plat:22, cost:1200000, accept:['chata'],   reqLvl:82 },
  q9:{ name:'Horská pila',     gx:31, gy:53, span:3, plat:22, cost:1800000, accept:['pila'],    reqLvl:83 },
  q10:{name:'Lanovka do sedla',gx:27, gy:58, span:2, plat:22, cost:2200000, accept:['lanovka'], reqLvl:85 },
  /* 23 Údolí potoka */
  q11:{name:'Turbína na potoce',gx:40,gy:53, span:3, plat:23, cost:600000,  accept:['hvoda'],   reqLvl:81 },
  q12:{name:'Chata u vody',    gx:45, gy:58, span:2, plat:23, cost:2000000, accept:['chata'],   reqLvl:86 },
  q13:{name:'Lázně v údolí',   gx:40, gy:58, span:3, plat:23, cost:6000000, accept:['lazne'],   reqLvl:88 },
  /* 24 Břidlicová stěna */
  q14:{name:'Krytinárna',      gx:53, gy:53, span:3, plat:24, cost:2600000, accept:['krytina'], reqLvl:86 },
  q15:{name:'Chata nad stěnou',gx:59, gy:53, span:2, plat:24, cost:2600000, accept:['chata'],   reqLvl:85 },
  q16:{name:'Sklad u stěny',   gx:53, gy:60, span:3, plat:24, cost:4000000, accept:['hsklad'],  reqLvl:89 },
  /* 25 Východní úbočí */
  q17:{name:'Lanovka na východ',gx:66,gy:53, span:2, plat:25, cost:3400000, accept:['lanovka'], reqLvl:87 },
  q18:{name:'Východní chata',  gx:71, gy:53, span:2, plat:25, cost:3800000, accept:['chata'],   reqLvl:88 },
  q19:{name:'Meteostanice',    gx:66, gy:59, span:2, plat:25, cost:5000000, accept:['meteo'],   reqLvl:89 },

  /* 26 Západní svah */
  r1:{ name:'Sjezdovka',       gx:1,  gy:66, span:4, plat:26, cost:9000000, accept:['sjezdovka'],reqLvl:84 },
  r2:{ name:'Chata pod sjezdovkou',gx:7,gy:66,span:2,plat:26, cost:3000000, accept:['chata'],   reqLvl:86 },
  r3:{ name:'Horská služba',   gx:1,  gy:71, span:2, plat:26, cost:4200000, accept:['hsluzba'], reqLvl:88 },
  /* 27 Kamenické dílny */
  r4:{ name:'Velká kamenická dílna',gx:14,gy:66,span:3,plat:27,cost:5000000,accept:['kamdilna'],reqLvl:87 },
  r5:{ name:'Sklad dílen',     gx:20, gy:66, span:3, plat:27, cost:6000000, accept:['hsklad'],  reqLvl:90 },
  r6:{ name:'Dělnická chata',  gx:14, gy:71, span:2, plat:27, cost:4600000, accept:['chata'],   reqLvl:88 },
  /* 28 Sedlo */
  r7:{ name:'Chata v sedle',   gx:27, gy:66, span:2, plat:28, cost:5200000, accept:['chata'],   reqLvl:88 },
  r8:{ name:'Větrník na hřebeni',gx:32,gy:66, span:3, plat:28, cost:8000000, accept:['hvitr'],  reqLvl:89 },
  r9:{ name:'Lanovka přes sedlo',gx:27,gy:71, span:2, plat:28, cost:5400000, accept:['lanovka'],reqLvl:90 },
  /* 29 Přehradní profil */
  r10:{name:'Přehrada',        gx:40, gy:67, span:4, plat:29, cost:14000000,accept:['hvoda'],   reqLvl:90 },
  r11:{name:'Chata nad přehradou',gx:46,gy:66,span:2,plat:29, cost:6000000, accept:['chata'],   reqLvl:91 },
  /* 30 Křemenná štola */
  r12:{name:'Sklárna',         gx:53, gy:66, span:3, plat:30, cost:7000000, accept:['sklarna'], reqLvl:91 },
  r13:{name:'Chata u štoly',   gx:59, gy:66, span:2, plat:30, cost:6400000, accept:['chata'],   reqLvl:92 },
  r14:{name:'Sklad u štoly',   gx:53, gy:71, span:3, plat:30, cost:9000000, accept:['hsklad'],  reqLvl:93 },
  /* 31 Východní sedlo */
  r15:{name:'Lanovka na vrchol',gx:66,gy:66, span:2, plat:31, cost:8000000, accept:['lanovka'], reqLvl:93 },
  r16:{name:'Chata ve východním sedle',gx:71,gy:66,span:2,plat:31,cost:7600000,accept:['chata'],reqLvl:93 },

  /* 32 Horská osada */
  s1:{ name:'Osada 1',         gx:1,  gy:79, span:2, plat:32, cost:3600000, accept:['chata'],   reqLvl:86 },
  s2:{ name:'Osada 2',         gx:5,  gy:79, span:2, plat:32, cost:4400000, accept:['chata'],   reqLvl:87 },
  s3:{ name:'Horský hotel',    gx:9,  gy:79, span:3, plat:32, cost:12000000,accept:['hhotel'],  reqLvl:90 },
  s4:{ name:'Lanovka do osady',gx:1,  gy:84, span:2, plat:32, cost:5000000, accept:['lanovka'], reqLvl:89 },
  /* 33 Pod vrcholem */
  s5:{ name:'Chata pod vrcholem',gx:14,gy:79,span:2, plat:33, cost:7000000, accept:['chata'],   reqLvl:90 },
  s6:{ name:'Zubačka',         gx:18, gy:79, span:4, plat:33, cost:20000000,accept:['zubacka'], reqLvl:92 },
  /* 34 Vrchol Kamenné */
  s7:{ name:'Rozhledna',       gx:27, gy:79, span:3, plat:34, cost:30000000,accept:['rozhledna'],reqLvl:94 },
  s8:{ name:'Vrcholová chata', gx:33, gy:79, span:2, plat:34, cost:11000000,accept:['chata'],   reqLvl:95 },
  /* 35 Zatopené údolí */
  s9:{ name:'Přístaviště',     gx:40, gy:79, span:3, plat:35, cost:9000000, accept:['hsklad'],  reqLvl:91 },
  s10:{name:'Chata u jezera',  gx:46, gy:79, span:2, plat:35, cost:8400000, accept:['chata'],   reqLvl:92 },
  /* 36 Vrchol Sklenné */
  s11:{name:'Druhá rozhledna', gx:53, gy:79, span:3, plat:36, cost:40000000,accept:['rozhledna'],reqLvl:96 },
  s12:{name:'Chata na Sklenné',gx:59, gy:79, span:2, plat:36, cost:13000000,accept:['chata'],   reqLvl:96 },
  /* 37 Hřeben */
  s13:{name:'Hřebenová chata', gx:66, gy:79, span:2, plat:37, cost:15000000,accept:['chata'],   reqLvl:98 },
  s14:{name:'Větrník na hřebeni 2',gx:71,gy:79,span:2,plat:37,cost:18000000,accept:['hvitr'],   reqLvl:98 },
...
const UNLOCKS = [
  ...
  { lv:60, t:'Úpravna vody',      d:'Velký zdroj · přidá 520 m³ do sítě' },
  ...
  { lv:73, t:'Reaktor blok 5',    d:'Výkon 2800 → 5400 MW' },
...
/* vlak z města: vozí staré suroviny, jede jako výrobní fronta */
const TRAIN = {
  name:'Vlak z města', dur:180000,          // jedna souprava za tři minuty
  cap:[200, 400, 700],                       // kolik uveze podle úrovně skladu
  ph:[
    { n:'Nástupní hrana', need:{sterk:200}, xp:26000 },
    { n:'Kolejiště',      need:{roxor:160}, xp:30000 },
    { n:'Rampa a jeřáb',  need:{traverza:90,dlazba:180}, xp:36000 }]
};
/* horský obchod: cena roste s tím, kolik už jsi nakoupil */
const MTN_BUY_MUL = 6;        // základ proti výkupní ceně
const MTN_STEP    = 10;       // po kolika kusech cena povyskočí
const MTN_RISE    = 0.15;     // o kolik
const MTN_COOL    = 600000;   // za jak dlouho spadne zpátky
...
/* ═══════════ HORY: VÝVOZ, SEZÓNY, KAMENICKÉ ZAKÁZKY ═══════════ */
/* vlak dolů do města — hlavní příjem horského kraje */
const EXPORT = {
  tiers:[
    { n:'Krátká jízda',  dur:15*60000, mul:3.0, qty:[90,140] },
    { n:'Dálková jízda', dur:30*60000, mul:3.6, qty:[200,300] },
    { n:'Noční expres',  dur:60*60000, mul:4.4, qty:[400,560] }]
};
...
/* kamenické zakázky — drobná práce mezi vlaky */
const MORDER = { min:[30,60], mid:[70,130], big:[150,240] };
const MORDER_MUL = 2.2;
